...
Description: This code provides an implementation of the splitting-based SMC-ABC method for network inference and parameter estimation in the stochastic multi-population JRNMM, proposed in the paper:
         
Network inference in a stochastic multi-population neural mass model, by S. Ditlevsen, M. Tamborrino and I. Tubikanec
...
2. Install the package SplittingJRNMM (splitting-simulation of paths of the JRNMM using C++ Code)

3. Run the R-file main_SMC_ABC_JRNMM (splitting-based SMC-ABC inference for the JRNMM)
